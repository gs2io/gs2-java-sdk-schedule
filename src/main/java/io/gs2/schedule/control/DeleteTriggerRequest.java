...
public class DeleteTriggerRequest extends Gs2UserRequest<DeleteTriggerRequest> {
	 ...
	 * @return this
	 */
	public DeleteTriggerRequest withScheduleName(String scheduleName) {
	 ...
	 * @return this
	 */
	public DeleteTriggerRequest withUserId(String userId) {
		setUserId(userId);
		return this;
	}
